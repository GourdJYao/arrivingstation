...
import com.yaojian.arrivingstation.adapter.GuideMainViewPagerAdatper;
import com.yaojian.arrivingstation.main.R;
import com.yaojian.arrivingstation.view.DepthPageTransformer;
...
public class GuideMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initData();
        mIn_vp.setAdapter(new GuideMainViewPagerAdatper(mViewList));
        addDots();
        moveDots();
    ...
    private void addDots() {
        ...
        mOne_dot.setImageResource(R.drawable.viewpage_guide_gray_dot);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutParams.setMargins(0, 0, 40, 0);
        mIn_ll.addView(mOne_dot, layoutParams);
        mTwo_dot = new ImageView(this);
        mTwo_dot.setImageResource(R.drawable.viewpage_guide_gray_dot);
        mIn_ll.addView(mTwo_dot, layoutParams);
        mThree_dot = new ImageView(this);
        mThree_dot.setImageResource(R.drawable.viewpage_guide_gray_dot);
    ...
    private void initData() {
        ...
        LayoutInflater lf = getLayoutInflater().from(GuideMainActivity.this);
        View view1 = lf.inflate(R.layout.viewpage_item_guide_one, null);
        View view2 = lf.inflate(R.layout.viewpage_item_guide_two, null);
        View view3 = lf.inflate(R.layout.viewpage_item_guide_three, null);
        mViewList.add(view1);
        mViewList.add(view2);
        mViewList.add(view3);
    }
